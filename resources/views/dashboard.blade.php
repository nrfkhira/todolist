                ...
                <ul class="list-group list-group-flush mt-3">
                    ...
                    <li class="list-group-item">
                        <form method="POST">
                            ...
                            <button formaction="{{ url('destroylist') }}/{{ $todolist->id}}" type="submit" class="btn btn-link btn-sm float-end"><i
                                    class="fas fa-trash"></i></button>
                            <button formaction="{{ url('listedit') }}/{{ $todolist->id}}" type="edit" class="btn btn-link btn-sm float-end"><i
